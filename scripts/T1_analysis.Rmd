...
gwas_sumstats[nrow(gwas_sumstats)+1,c("code","name", "nCase","nControl","gwasReferenceDOI","populationPrevalence","prevalenceReferenceDOI","filePath")] <- list(
  ...
  filePath=file.path(folderpath.data,"gwas_sumstats","munged_1kg_eur_supermunge","DEPR08.gz")
  )
...
gwas_sumstats[nrow(gwas_sumstats)+1,c("code","name", "nCase","nControl","gwasReferenceDOI","populationPrevalence","prevalenceReferenceDOI","filePath")]<- list(
  ...
  filePath=file.path(folderpath.data,"gwas_sumstats","munged_1kg_eur_supermunge","NEUR02.gz")
  )
