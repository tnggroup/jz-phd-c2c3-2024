# Modified version by JKZ 2020
# DO NOT USE THIS - USE THE "johanzvrskovec/GenomicSEM" GitHub repository instead, specifying the correct experimental branch
require(plyr)
require(e1071)
require(readr)
require(gdata)
...
hdl.mod <- function(traits,sample.prev=NA,population.prev=NA,trait.names=NULL,LD.path,Nref = 335265,method="piecewise"){
  ...
  ##calculate standardized results to print genetic correlations
