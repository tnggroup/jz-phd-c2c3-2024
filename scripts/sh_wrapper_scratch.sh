...
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a ANXI03 -l cluster" --output "setup8.munge.ANXI03.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a BIPO02 -l cluster" --output "setup8.munge.BIPO02.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a BODY14 -l cluster" --output "setup8.munge.BODY14.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a BODYTM -l cluster" --output "setup8.munge.BODYTM.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a BODYTF -l cluster" --output "setup8.munge.BODYTF.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a DEPR05 -l cluster" --output "setup8.munge.DEPR05.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a DEPR5B -l cluster" --output "setup8.munge.DEPR5B.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a DEPR09 -l cluster" --output "setup8.munge.DEPR09.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a EDUC03 -l cluster" --output "setup8.munge.EDUC03.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a HEIG04M -l cluster" --output "setup8.munge.HEIG04M.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a HEIG04F -l cluster" --output "setup8.munge.HEIG04F.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a HEIG09 -l cluster" --output "setup8.munge.HEIG09.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a INSO02 -l cluster" --output "setup8.munge.INSO02.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a NEUR02 -l cluster" --output "setup8.munge.NEUR02.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a SCHI04 -l cluster" --output "setup8.munge.SCHI04.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a WEIG04M -l cluster" --output "setup8.munge.WEIG04M.$(date +%Y%m%d).out.txt"
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t munge -a WEIG04F -l cluster" --output "setup8.munge.WEIG04F.$(date +%Y%m%d).out.txt"

sbatch --time 2-00:00:00 --partition cpu --job-name="iANXI03" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a ANXI03 -l cluster" --output "setup8.ldimp.ANXI03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBIPO02" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a BIPO02 -l cluster" --output "setup8.ldimp.BIPO02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBODY14" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a BODY14 -l cluster" --output "setup8.ldimp.BODY14.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBODYTM" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a BODYTM -l cluster" --output "setup8.ldimp.BODYTM.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR05" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a DEPR05 -l cluster" --output "setup8.ldimp.DEPR05.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR5B" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a DEPR5B -l cluster" --output "setup8.ldimp.DEPR5B.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR09" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a DEPR09 -l cluster" --output "setup8.ldimp.DEPR09.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iEDUC03" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a EDUC03 -l cluster" --output "setup8.ldimp.EDUC03.$(date +%Y%m%d).out.txt"
#sbatch --time 2-00:00:00 --partition cpu --job-name="iGWISM" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a GWISM -l cluster" --output "setup8.ldimp.GWISM.$(date +%Y%m%d).out.txt"
#sbatch --time 2-00:00:00 --partition cpu --job-name="iGWISI" --ntasks 1 --cpus-per-task 4 --mem 80G --wrap="Rscript setup8.R -t impute -a GWISI -l cluster" --output "setup8.ldimp.GWISI.$(date +%Y%m%d).out.txt" #no, use the one also placed in the munged folder
sbatch --time 2-00:00:00 --partition cpu --job-name="iHEIG04M" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a HEIG04M -l cluster" --output "setup8.ldimp.HEIG04M.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iHEIG04F" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a HEIG04F -l cluster" --output "setup8.ldimp.HEIG04F.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iINSO02" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a INSO02 -l cluster" --output "setup8.ldimp.INSO02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iNEUR02" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a NEUR02 -l cluster" --output "setup8.ldimp.NEUR02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iSCHI04" --ntasks 1 --cpus-per-task 6 --mem 80G --wrap="Rscript setup8.R -t impute -a SCHI04 -l cluster" --output "setup8.ldimp.SCHI04.$(date +%Y%m%d).out.txt"
