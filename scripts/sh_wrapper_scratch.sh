...
sbatch --time 23:59:00 --partition brc,shared --job-name="GSEMGWAS" --ntasks 1 --cpus-per-task 2 --mem-per-cpu 6G --wrap="Rscript setup1.R -l cluster" --output "setup1.out" --error "setup1.err"
