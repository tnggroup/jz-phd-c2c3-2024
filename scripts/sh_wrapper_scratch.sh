...
sbatch --time 2-00:00:00 --partition cpu --job-name="iANXI03" --ntasks 1 --cpus-per-task 4 --mem 50G --wrap="Rscript setup8.R -t impute -a ANXI03 -l cluster" --output "setup8.ldimp.ANXI03.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iBIPO02" --ntasks 1 --cpus-per-task 4 --mem 50G --wrap="Rscript setup8.R -t impute -a BIPO02 -l cluster" --output "setup8.ldimp.BIPO02.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR09" --ntasks 1 --cpus-per-task 4 --mem 50G --wrap="Rscript setup8.R -t impute -a DEPR09 -l cluster" --output "setup8.ldimp.DEPR09.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iEDUC03" --ntasks 1 --cpus-per-task 4 --mem 50G --wrap="Rscript setup8.R -t impute -a EDUC03 -l cluster" --output "setup8.ldimp.EDUC03.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iINSO02" --ntasks 1 --cpus-per-task 4 --mem 50G --wrap="Rscript setup8.R -t impute -a INSO02 -l cluster" --output "setup8.ldimp.INSO02.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iNEUR02" --ntasks 1 --cpus-per-task 4 --mem 50G --wrap="Rscript setup8.R -t impute -a NEUR02 -l cluster" --output "setup8.ldimp.NEUR02.$(date +%Y%m%d).out.txt"
