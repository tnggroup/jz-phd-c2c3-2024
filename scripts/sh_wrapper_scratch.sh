...
sbatch --time 24:00:00 --partition cpu --job-name="smunge" --ntasks 1 --cpus-per-task 4 --mem 10G --wrap="Rscript setup8.R -t munge -a DEPR5B -l cluster" --output "setup8.munge.DEPR5B.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a ADHD05 -l cluster" --output "setup8.ldimp.ADHD05.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a ALCD03 -l cluster" --output "setup8.ldimp.ALCD03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a ANOR02 -l cluster" --output "setup8.ldimp.ANOR02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a ANXI03 -l cluster" --output "setup8.ldimp.ANXI03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a ANXI04 -l cluster" --output "setup8.ldimp.ANXI04.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a AUTI07 -l cluster" --output "setup8.ldimp.AUTI07.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a BIPO02 -l cluster" --output "setup8.ldimp.BIPO02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a BODY11 -l cluster" --output "setup8.ldimp.BODY11.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a BVOL01 -l cluster" --output "setup8.ldimp.BVOL01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a DEPR05 -l cluster" --output "setup8.ldimp.DEPR05.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a DEPR5B -l cluster" --output "setup8.ldimp.DEPR5B.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a DEPR09 -l cluster" --output "setup8.ldimp.DEPR09.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a EDUC03 -l cluster" --output "setup8.ldimp.EDUC03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a HEAL01 -l cluster" --output "setup8.ldimp.HEAL01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a INCO03 -l cluster" --output "setup8.ldimp.INCO03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a INSO02 -l cluster" --output "setup8.ldimp.INSO02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a INSO03 -l cluster" --output "setup8.ldimp.INSO03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a NEUR02 -l cluster" --output "setup8.ldimp.NEUR02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a PTSD04 -l cluster" --output "setup8.ldimp.PTSD04.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a RISK02 -l cluster" --output "setup8.ldimp.RISK02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a RISK03 -l cluster" --output "setup8.ldimp.RISK03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a SCHI04 -l cluster" --output "setup8.ldimp.SCHI04.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a SUBJ01 -l cluster" --output "setup8.ldimp.SUBJ01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="ldimp" --ntasks 1 --cpus-per-task 4 --mem 30G --wrap="Rscript setup8.R -t impute -a TIRE01 -l cluster" --output "setup8.ldimp.TIRE01.$(date +%Y%m%d).out.txt"
