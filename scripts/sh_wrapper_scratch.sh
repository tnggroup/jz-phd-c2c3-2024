...
sbatch --time 23:59:00 --partition brc,shared --job-name="mvHDLt7" --ntasks 1 --cpus-per-task 4 --mem-per-cpu 5G --wrap="Rscript setup1.R -t 7 -l cluster" --output "setup1.t7.out" --error "setup1.t7.err"
sbatch --time 23:59:00 --partition brc,shared --job-name="mvHDLt8" --ntasks 1 --cpus-per-task 4 --mem-per-cpu 5G --wrap="Rscript setup1.R -t 8 -l cluster" --output "setup1.t8.out" --error "setup1.t8.err"
