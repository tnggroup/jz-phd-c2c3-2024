...
srun -p cpu --ntasks 1 --cpus-per-task 6 --mem 32G --pty /bin/bash
...
#simulated gwas - run in gwas_sumstats/raw


sbatch --time 24:00:00 --partition cpu --job-name="sim010" --ntasks 1 --cpus-per-task 6 --mem 64G --wrap="module add gcta; gcta-1.94.1 --bfile ../../reference_panel/hc1kgp3.b38.plink/1kGP_high_coverage_Illumina.filtered.SNV_INDEL_SV_phased_panel.frq.CM.eur --simu-qt --simu-causal-loci neuro02.sim.varlist --simu-hsq 0.10 --out sim010;" --output "setup8.sim010.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iADHD05" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a ADHD05 -l cluster" --output "setup8.ldimp.ADHD05.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iALCD03" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a ALCD03 -l cluster" --output "setup8.ldimp.ALCD03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iANOR02" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a ANOR02 -l cluster" --output "setup8.ldimp.ANOR02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iANXI03" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a ANXI03 -l cluster" --output "setup8.ldimp.ANXI03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iANXI04" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a ANXI04 -l cluster" --output "setup8.ldimp.ANXI04.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iAUTI07" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a AUTI07 -l cluster" --output "setup8.ldimp.AUTI07.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBIPO02" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a BIPO02 -l cluster" --output "setup8.ldimp.BIPO02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBODY11" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a BODY11 -l cluster" --output "setup8.ldimp.BODY11.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBODYTM" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a BODYTM -l cluster" --output "setup8.ldimp.BODYTM.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iBVOL01" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a BVOL01 -l cluster" --output "setup8.ldimp.BVOL01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR05" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a DEPR05 -l cluster" --output "setup8.ldimp.DEPR05.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR5B" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a DEPR5B -l cluster" --output "setup8.ldimp.DEPR5B.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iDEPR09" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a DEPR09 -l cluster" --output "setup8.ldimp.DEPR09.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iEDUC03" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a EDUC03 -l cluster" --output "setup8.ldimp.EDUC03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iGWISM" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a GWISM -l cluster" --output "setup8.ldimp.GWISM.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iHEAL01" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a HEAL01 -l cluster" --output "setup8.ldimp.HEAL01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iHEIG04M" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a HEIG04M -l cluster" --output "setup8.ldimp.HEIG04M.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iHEIG04F" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a HEIG04F -l cluster" --output "setup8.ldimp.HEIG04F.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iHEIG09" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a HEIG09 -l cluster" --output "setup8.ldimp.HEIG09.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iINCO03" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a INCO03 -l cluster" --output "setup8.ldimp.INCO03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iINSO02" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a INSO02 -l cluster" --output "setup8.ldimp.INSO02.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="iNEUR02" --ntasks 1 --cpus-per-task 6 --mem 60G --wrap="Rscript setup8.R -t impute -a NEUR02 -l cluster" --output "setup8.ldimp.NEUR02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iPTSD04" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a PTSD04 -l cluster" --output "setup8.ldimp.PTSD04.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iRISK02" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a RISK02 -l cluster" --output "setup8.ldimp.RISK02.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iRISK03" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a RISK03 -l cluster" --output "setup8.ldimp.RISK03.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iSCHI04" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a SCHI04 -l cluster" --output "setup8.ldimp.SCHI04.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iSUBJ01" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a SUBJ01 -l cluster" --output "setup8.ldimp.SUBJ01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iTIRE01" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a TIRE01 -l cluster" --output "setup8.ldimp.TIRE01.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iWEIG04M" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a WEIG04M -l cluster" --output "setup8.ldimp.WEIG04M.$(date +%Y%m%d).out.txt"
sbatch --time 2-00:00:00 --partition cpu --job-name="iWEIG04F" --ntasks 1 --cpus-per-task 6 --mem 50G --wrap="Rscript setup8.R -t impute -a WEIG04F -l cluster" --output "setup8.ldimp.WEIG04F.$(date +%Y%m%d).out.txt"
...
sbatch --time 2-00:00:00 --partition cpu --job-name="mvLD" --ntasks 1 --cpus-per-task 6 --mem 64G --wrap="Rscript setup8.R -t mvLD -l cluster" --output "setup8.mvLD.$(date +%Y%m%d).out.txt"
#for running original ldsc - using the . sh equivalent to bash source to activate the virtual python envoronment
sbatch --time 2-00:00:00 --partition cpu --job-name="mvLD" --ntasks 1 --cpus-per-task 6 --mem 64G --wrap=". /users/k19049801/project/JZ_GED_PHD_ADMIN_GENERAL/software/ldsc-venv/bin/activate; Rscript setup8.R -t mvLD -l cluster;" --output "setup8.mvLD.$(date +%Y%m%d).out.txt"
...
#run ldsc manually - test
#/users/k19049801/project/JZ_GED_PHD_ADMIN_GENERAL/software/ldsc/ldsc.py --n-blocks 250 --ref-ld /users/k19049801/project/JZ_GED_PHD_C1/data/ld_scores/hc1kgp3.b38.eur.l2.jz2023/hc1kgp3.b38.eur.jz2023.1cm.250blocks --rg /users/k19049801/project/JZ_GED_PHD_C1/data/gwas_sumstats/munged_1kg_eur_supermunge/BODY14.gz,/users/k19049801/project/JZ_GED_PHD_C1/data/gwas_sumstats/munged_1kg_eur_supermunge/NEUR02.gz --samp-prev nan,nan --pop-prev nan,nan --no-check-alleles --out test.ldsc
