...
write.table(project$sumstats.sel[,c("code_orig", "gwas_name","reference_year", "n_case","n_control","n_total","samplePrevalence","populationPrevalence", "reference_doi")], file = paste0(project$folderpath.workingDirectory,"/","project.",project$setup.code,".sumstatsinfo.csv"), quote = TRUE, sep = ",", eol = "\r", row.names = FALSE, col.names = TRUE)
...
project$plots.efa.plot.scree<-fa.parallel(project$mvLD$covstruct.mvLDSC$S_Stand, fa = "fa")
png(filename = paste0(project$folderpath.plots,"/","efa.plot.scree.png"), width = 800, height = 500)
fa.parallel(project$mvLD$covstruct.mvLDSC$S_Stand, fa = "fa")
dev.off()
...
project$functions$cfa.model.define<-function(code.indicator,allow_loading.table.indicator_factor, fix_loading.table.indicator_factor=NULL, special.orthogonal=FALSE){
...
#test
# lavaanDefinition<-project$functions$cfa.model.define(code.indicator = project$sumstats.sel$code.trait, allow_loading.table.indicator_factor = data.frame(
...
project$functions$cfa.model.calculateLogicalLoadingsFromEFA<-function(loadings.table.indicator_factor,absCutoff){
...
project$functions$cfa.model.calculateLogicalFixedLoadingsFromEFA<-function(loadings.table.indicator_factor){
...
project$functions$cfa.model.evaluate<-function(covstruc, model, estimation="ML", code="defaultEvaluatedModel"){
