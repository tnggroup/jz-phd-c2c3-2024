...
createTableEntriesFull<-function(code,cCovstruct,simulatedTraitsTable){
  # cols <-c("Avg. SIM1 LDSR h2","Avg. SIM1 REML h2","Avg. SIM2 LDSR h2","Avg. SIM2 REML h2","Avg. SIM LDSR h2","Avg. SIM REML h2","Avg. SIM1 & SIM2 LDSR covG","Avg. SIM1 & SIM2 REML covG","RMSE(S)","RMSE(diag S)","RMSE(off diag S)")
  cols <-c("Avg. SIM1 h2","Avg. SIM2 h2","Avg. SIM h2","Avg. SIM1 & SIM2 covG","RMSE(S)","RMSE(diag S)","RMSE(off diag S)")
  ...
  # (p$mvLD$covstruct.GCTA$S["SMRV01","SMRV01"] + p$mvLD$covstruct.GCTA$S["SMRV03","SMRV03"] +
  #   p$mvLD$covstruct.GCTA$S["SMRV05","SMRV05"] + p$mvLD$covstruct.GCTA$S["SMRV07","SMRV07"])/4,

  (cCovstruct$S["SMRV02","SMRV02"] + cCovstruct$S["SMRV04","SMRV04"] +
    cCovstruct$S["SMRV06","SMRV06"] + cCovstruct$S["SMRV08","SMRV08"])/4,

  # (p$mvLD$covstruct.GCTA$S["SMRV02","SMRV02"] + p$mvLD$covstruct.GCTA$S["SMRV04","SMRV04"] +
  #   p$mvLD$covstruct.GCTA$S["SMRV06","SMRV06"] + p$mvLD$covstruct.GCTA$S["SMRV08","SMRV08"])/4,
  
  mean(diag(cCovstruct$S),na.rm=T),
  
  #mean(diag(p$mvLD$covstruct.GCTA$S),na.rm=T),
  
  (cCovstruct$S["SMRV01","SMRV02"] + cCovstruct$S["SMRV03","SMRV04"] + 
    cCovstruct$S["SMRV05","SMRV06"] + cCovstruct$S["SMRV07","SMRV08"])/4,
  
   # (p$mvLD$covstruct.GCTA$S["SMRV01","SMRV02"] + p$mvLD$covstruct.GCTA$S["SMRV03","SMRV04"] + 
   #  p$mvLD$covstruct.GCTA$S["SMRV05","SMRV06"] + p$mvLD$covstruct.GCTA$S["SMRV07","SMRV08"])/4,
...
createTableEntriesPairwise<-function(code,cCovstruct,simulatedTraitsTable,t1,t2){
  ...
  #p$mvLD$covstruct.GCTA$S[t1,t1],
  
  cCovstruct$S[t2,t2],
  
  #p$mvLD$covstruct.GCTA$S[t2,t2],
  
  mean(diag(cCovstruct$S[c(t1,t2),c(t1,t2)]),na.rm=T),
  
  #mean(diag(p$mvLD$covstruct.GCTA$S[c(t1,t2),c(t1,t2)]),na.rm=T),
  
  cCovstruct$S[t1,t2],
  
  #p$mvLD$covstruct.GCTA$S[t1,t2],
...
createTableEntriesFull<-function(code,cCovstruct,simulatedTraitsTable){
  #cols <-c("Avg. SIM1 LDSR h2 S.E.","Avg. SIM1 REML h2 S.E.","Avg. SIM2 LDSR h2 S.E.","Avg. SIM2 REML h2 S.E.","Avg. SIM LDSR h2 S.E.","Avg. SIM REML h2 S.E.","Avg. SIM1 & SIM2 LDSR covG S.E.","Avg. SIM1 & SIM2 REML covG S.E.","RMSE(S S.E.)","RMSE(diag S S.E.)","RMSE(off diag S S.E.)")
   cols <-c("Avg. SIM1 h2 S.E.","Avg. SIM2 h2 S.E.","Avg. SIM h2 S.E.","Avg. SIM1 & SIM2 covG S.E.","RMSE(S S.E.)","RMSE(diag S S.E.)","RMSE(off diag S S.E.)","Avg. SIM1 h2 CV","Avg. SIM2 h2 CV","Avg. SIM h2 CV","Avg. SIM1 & SIM2 covG CV","RMSE(CV)","RMSE(diag S CV)","RMSE(off diag S CV)")
  ...
  # (p$mvLD$covstruct.GCTA$S.SE["SMRV01","SMRV01"] + p$mvLD$covstruct.GCTA$S.SE["SMRV03","SMRV03"] + 
  #   p$mvLD$covstruct.GCTA$S.SE["SMRV05","SMRV05"] + p$mvLD$covstruct.GCTA$S.SE["SMRV07","SMRV07"])/4,
  
  (cCovstruct$S.SE["SMRV02","SMRV02"] + cCovstruct$S.SE["SMRV04","SMRV04"] + 
    cCovstruct$S.SE["SMRV06","SMRV06"] + cCovstruct$S.SE["SMRV08","SMRV08"])/4,
  
  # (p$mvLD$covstruct.GCTA$S.SE["SMRV02","SMRV02"] + p$mvLD$covstruct.GCTA$S.SE["SMRV04","SMRV04"] + 
  #   p$mvLD$covstruct.GCTA$S.SE["SMRV06","SMRV06"] + p$mvLD$covstruct.GCTA$S.SE["SMRV08","SMRV08"])/4,
  
  mean(diag(cCovstruct$S.SE),na.rm=T),
  
  #mean(diag(p$mvLD$covstruct.GCTA$S.SE),na.rm=T),
  
  (cCovstruct$S.SE["SMRV01","SMRV02"] + cCovstruct$S.SE["SMRV03","SMRV04"] + 
    cCovstruct$S.SE["SMRV05","SMRV06"] + cCovstruct$S.SE["SMRV07","SMRV08"])/4,
  
   # (p$mvLD$covstruct.GCTA$S.SE["SMRV01","SMRV02"] + p$mvLD$covstruct.GCTA$S.SE["SMRV03","SMRV04"] + 
   #  p$mvLD$covstruct.GCTA$S.SE["SMRV05","SMRV06"] + p$mvLD$covstruct.GCTA$S.SE["SMRV07","SMRV08"])/4,
...
createTableEntriesPairwise<-function(code,cCovstruct,simulatedTraitsTable,t1,t2){
  ...
  #p$mvLD$covstruct.GCTA$S.SE[t1,t1],
  
  cCovstruct$S.SE[t2,t2],
  
  #p$mvLD$covstruct.GCTA$S.SE[t2,t2],
  
  mean(diag(cCovstruct$S.SE[c(t1,t2),c(t1,t2)]),na.rm=T),
  
  #mean(diag(p$mvLD$covstruct.GCTA$S.SE[c(t1,t2),c(t1,t2)]),na.rm=T),
  
  cCovstruct$S.SE[t1,t2],
  
  #p$mvLD$covstruct.GCTA$S.SE[t1,t2],
