...
p$sumstats[nrow(p$sumstats)+1,c("code","name", "n_case","n_control","n_total","phenotype_id","reference_id","reference_doi")]=list(
  ...
  phenotype_id=171,
  reference_id=NA_integer_,
  reference_doi=c("10.1038/s41588-022-01124-w")
  )
...
p$sumstats[nrow(p$sumstats)+1,c("code","name", "n_case","n_control","n_total","phenotype_id","reference_id","reference_doi")]=list(
  ...
  reference_id=NA_integer_,
  reference_doi=c("10.1038/s41467-020-19378-5")
  )
...
#read manual metadata describing the imputation and ldsc variant counts
p$filepath.manualmeta.impstats <- file.path(p$folderpath.data,"impstats.tsv.txt")
p$filepath.manualmeta.ldscstats <- file.path(p$folderpath.data,"ldscstats.tsv.txt")
...
if(file.exists(p$filepath.manualmeta.ldscstats)){
  manualMeta <- as.data.frame(shru::readFile(filePath = p$filepath.manualmeta.ldscstats))
  rownames(manualMeta)<-manualMeta$trait
  p$sumstats[rownames(manualMeta),c("variants_mvldsc_hm3_nohighld","variants_mvldsc_1kg_nohighld","variants_mvldsc_1kg500_nohighld","variants_mvldsc_1kgssimp_nohighld","variants_ldsc_1kg_nohighld","variants_ldsc_1kg500_nohighld","variants_ldsc_1kgssimp_nohighld")]<-manualMeta[rownames(manualMeta),c("n_mvldsc_hm3_nohighld","n_mvldsc_1kg_nohighld","n_mvldsc_1kg500_nohighld","n_mvldsc_1kgssimp_nohighld","n_ldsc_1kg_nohighld","n_ldsc_1kg500_nohighld","n_ldsc_1kgssimp_nohighld")]
  rm(manualMeta)
}
...
#tests
#p$sumstats.sel.ssimp.code <- c("ANXI03","DEPR5B") #TEST
#p$sumstats.sel.ssimp.code <- c("ANXI03","DEPR5B","DEPR05","DEPR09","SCHI04","NEUR02") #TEST
...
#all traits
#p$sumstats.sel.code<-c("ADHD05","ALCD03","ANOR02","ANXI03","ANXI04","AUTI07","BODY11","BIPO02", "BVOL01","DEPR05","DEPR5B","DEPR09","EDUC03","HEAL01","INCO03","INSO03","NEUR02", "PTSD04","RISK02","RISK03","SCHI04","SUBJ01","TIRE01")
...
if(p$clOptions$task=="munge" & !all(file.exists(p$sumstats.sel$mungedpath))){
  ...
  #test
  #p$clOptions$task_argument<-"ADHD05"
...
if(p$clOptions$task=="mvLD" || (!file.exists(p$filepath.mvLD) & p$clOptions$task=="0"))
{
  ...
  #test of ldsc2
  # p$mvLD$covstruct.mvLDSC.hm3.ldsc2<-ldsc2(
  ...
  p$mvLD$covstruct.mvLDSC.hm3<-ldsc2(
  ...
  p$mvLD$covstruct.mvLDSC.1kg.small<-ldsc2(
    traits = p$sumstats.sel$mungedpath,
    sample.prev =  p$sumstats.sel$samplePrevalence,
    population.prev = p$sumstats.sel$populationPrevalence,
    trait.names = p$sumstats.sel$code,
  ...
  p$mvLD$covstruct.mvLDSC.1kg<-ldsc2(
    traits = p$sumstats.sel$mungedpath,
    sample.prev =  p$sumstats.sel$samplePrevalence,
    population.prev = p$sumstats.sel$populationPrevalence,
    trait.names = p$sumstats.sel$code,
  ...
  p$mvLD$covstruct.mvLDSC.1kg.500.small<-ldsc2(
  ...
  p$mvLD$covstruct.mvLDSC.1kg.500<-ldsc2(
    traits = p$sumstats.sel$imputedpath.500,
    sample.prev =  p$sumstats.sel$samplePrevalence,
    population.prev = p$sumstats.sel$populationPrevalence,
    trait.names = p$sumstats.sel$code,
  ...
  p$mvLD$covstruct.mvLDSC.1kg.ssimp.small<-ldsc2(
...
p$sumstats.sel$h2.liability_mvLDSC.1kg<-diag(p$mvLD$covstruct.mvLDSC.1kg.small$S[p$sumstats.sel$code,p$sumstats.sel$code])
p$sumstats.sel$h2.se.liability_mvLDSC.1kg<-diag(p$mvLD$covstruct.mvLDSC.1kg.small$S.SE[p$sumstats.sel$code,p$sumstats.sel$code])
p$sumstats.sel$h2.liability_mvLDSC.1kg.ldimp<-diag(p$mvLD$covstruct.mvLDSC.1kg.500.small$S[p$sumstats.sel$code,p$sumstats.sel$code])
p$sumstats.sel$h2.se.liability_mvLDSC.1kg.ldimp<-diag(p$mvLD$covstruct.mvLDSC.1kg.500.small$S.SE[p$sumstats.sel$code,p$sumstats.sel$code])
p$sumstats.sel$h2.liability_mvLDSC.1kg.ssimp<-diag(p$mvLD$covstruct.mvLDSC.1kg.ssimp.small$S[p$sumstats.sel$code,p$sumstats.sel$code])
p$sumstats.sel$h2.se.liability_mvLDSC.1kg.ssimp<-diag(p$mvLD$covstruct.mvLDSC.1kg.ssimp.small$S.SE[p$sumstats.sel$code,p$sumstats.sel$code])

p$sumstats.sel$h2_orig.liability_mvLDSC.1kg<-as.numeric(lapply(X = p$mvLD$h2.munged, FUN = function(x){ifelse(any(colnames(x$df)=="h2_liab"),x$df$h2_liab,x$df$h2_obs)}))
p$sumstats.sel$h2_orig.se.liability_mvLDSC.1kg<-as.numeric(lapply(X = p$mvLD$h2.munged, FUN = function(x){ifelse(any(colnames(x$df)=="h2_liab_se"),x$df$h2_liab_se,x$df$h2_obs_se)}))
p$sumstats.sel$h2_orig.liability_mvLDSC.1kg.ldimp<-as.numeric(lapply(X = p$mvLD$h2.500, FUN = function(x){ifelse(any(colnames(x$df)=="h2_liab"),x$df$h2_liab,x$df$h2_obs)}))
p$sumstats.sel$h2_orig.se.liability_mvLDSC.1kg.ldimp<-as.numeric(lapply(X = p$mvLD$h2.500, FUN = function(x){ifelse(any(colnames(x$df)=="h2_liab_se"),x$df$h2_liab_se,x$df$h2_obs_se)}))
p$sumstats.sel$h2_orig.liability_mvLDSC.1kg.ssimp<-as.numeric(lapply(X = p$mvLD$h2.ssimp, FUN = function(x){ifelse(any(colnames(x$df)=="h2_liab"),x$df$h2_liab,x$df$h2_obs)}))
p$sumstats.sel$h2_orig.se.liability_mvLDSC.1kg.ssimp<-as.numeric(lapply(X = p$mvLD$h2.ssimp, FUN = function(x){ifelse(any(colnames(x$df)=="h2_liab_se"),x$df$h2_liab_se,x$df$h2_obs_se)}))
...
p$mvLD$S_Stand.deltapanel.rel <- 100*(clipValues(p$mvLD$covstruct.mvLDSC.1kg$S_Stand, min = -1, max = 1) - clipValues(p$mvLD$covstruct.mvLDSC.hm3$S_Stand, min = -1, max = 1))/abs(clipValues(p$mvLD$covstruct.mvLDSC.hm3$S_Stand, min = -1, max = 1))
p$mvLD$S_Stand.SE.deltapanel.rel <- 100*(p$mvLD$covstruct.mvLDSC.1kg$S_Stand.SE - p$mvLD$covstruct.mvLDSC.hm3$S_Stand.SE)/abs(p$mvLD$covstruct.mvLDSC.hm3$S_Stand.SE)
...
p$sumstats.sel.table<-p$sumstats.sel[,c("name.nice.and_code",
                                        ...
                                        "h2.liability_mvLDSC.1kg.ssimp",
                                        "h2.se.liability_mvLDSC.1kg.ssimp",
                                        "h2_orig.liability_mvLDSC.1kg",
                                        "h2_orig.se.liability_mvLDSC.1kg",
                                        "h2_orig.liability_mvLDSC.1kg.ldimp",
                                        "h2_orig.se.liability_mvLDSC.1kg.ldimp",
                                        "h2_orig.liability_mvLDSC.1kg.ssimp",
                                        "h2_orig.se.liability_mvLDSC.1kg.ssimp"
                                        )]
...
p$sumstats.sel.table$h2.liability_mvLDSC.1kg.ssimp.table<-paste0(round( p$sumstats.sel.table$h2.liability_mvLDSC.1kg.ssimp,digits = 3)," (",round(p$sumstats.sel.table$h2.se.liability_mvLDSC.1kg.ssimp,digits = 4),")")

p$sumstats.sel.table$h2_orig.liability_mvLDSC.1kg.table<-paste0(round( p$sumstats.sel.table$h2_orig.liability_mvLDSC.1kg,digits = 3)," (",round(p$sumstats.sel.table$h2_orig.se.liability_mvLDSC.1kg,digits = 4),")")

p$sumstats.sel.table$h2_orig.liability_mvLDSC.1kg.ldimp.table<-paste0(round( p$sumstats.sel.table$h2_orig.liability_mvLDSC.1kg.ldimp,digits = 3)," (",round(p$sumstats.sel.table$h2_orig.se.liability_mvLDSC.1kg.ldimp,digits = 4),")")

p$sumstats.sel.table$h2_orig.liability_mvLDSC.1kg.ssimp.table<-paste0(round( p$sumstats.sel.table$h2_orig.liability_mvLDSC.1kg.ssimp,digits = 3)," (",round(p$sumstats.sel.table$h2_orig.se.liability_mvLDSC.1kg.ssimp,digits = 4),")")
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table %>% 
  gt() %>% 
  #fmt_number(columns = vars(log_nxm_mvldsc_1kg500_nohighld), decimals = 2) %>%
  tab_header(
    title = "Selected GWAS summary statistics datasets, heritabilities"
  ) %>% cols_label(
    name.nice.and_code  = "Trait",
    ...
    h2.liability_mvLDSC.1kg.ldimp.table = html("h<sup>2</sup><sub>mvldsc, 1kg & LD-IMP*</sub> (sd)"),
...
#selected sumstats, variants counts
p$sumstats.sel.table<-p$sumstats.sel[,c("name.nice.and_code",
                                        "h_cpu_ldimp",
                                        "h_cpu_ssimp",
                                        "variants_raw",
                                        "variants_ldimp",
                                        "variants_ssimp",
                                        "variants_mvldsc_hm3_nohighld",
                                        "variants_mvldsc_1kg_nohighld",
                                        "variants_mvldsc_1kgssimp_nohighld",
                                        "variants_mvldsc_1kg500_nohighld",
                                        "variants_ldsc_1kg_nohighld",
                                        "variants_ldsc_1kgssimp_nohighld",
                                        "variants_ldsc_1kg500_nohighld"
                                        )]

p$plots.sumstats.sel.table<-p$sumstats.sel.table %>% 
  gt() %>% 
  fmt_number(columns = vars(variants_raw,variants_ldimp,variants_ssimp,variants_mvldsc_hm3_nohighld,variants_mvldsc_1kg_nohighld,variants_mvldsc_1kg500_nohighld,variants_mvldsc_1kgssimp_nohighld,variants_ldsc_1kg_nohighld,variants_ldsc_1kg500_nohighld,variants_ldsc_1kgssimp_nohighld), decimals = 0) %>%
  tab_header(
    title = "Selected GWAS summary statistics datasets, variant count"
  ) %>% cols_label(
    name.nice.and_code  = "Trait",
    h_cpu_ldimp = md("CPU hours<sub>LD-IMP</sub>"),
    h_cpu_ssimp = md("CPU hours<sub>SSIMP</sub>"),
    variants_raw = md("M<sub>raw</sub>"),
    variants_ldimp = md("M<sub>1kg & LD-IMP</sub>"),
    variants_ssimp = md("M<sub>1kg & SSIMP</sub>"),
    variants_mvldsc_hm3_nohighld = md("M<sub>mvldsc, hm3</sub>"),
    variants_mvldsc_1kg_nohighld = md("M<sub>mvldsc, 1kg</sub>"),
    variants_mvldsc_1kg500_nohighld = md("M<sub>mvldsc, 1kg & LD-IMP</sub>"),
    variants_mvldsc_1kgssimp_nohighld = md("M<sub>mvldsc, 1kg & SSIMP*</sub>"),
    variants_ldsc_1kg_nohighld = md("M<sub>ldsc, 1kg</sub>"),
    variants_ldsc_1kg500_nohighld = md("M<sub>ldsc, 1kg & LD-IMP</sub>"),
    variants_ldsc_1kgssimp_nohighld = md("M<sub>ldsc, 1kg & SSIMP</sub>")
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
gtsave(data = p$plots.sumstats.sel.table, filename = paste0(p$folderpath.plots,"/sumstats.sel.table.variants.rtf"))
