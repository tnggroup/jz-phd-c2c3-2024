...
#     traits = p$sumstats.sel.ssimp$mungedpath.ldsc.1kg.orig.maf0_01,
#     sample.prev =  p$sumstats.sel.ssimp$samplePrevalence.balanced,
#     population.prev = p$sumstats.sel.ssimp$populationPrevalence,
#     trait.names = p$sumstats.sel.ssimp$code,
...
test.GSEMemulation_vs_originalLDSC<-test.meta.deltacovariance.matrix(
  ...
  mN1 = p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.maf0_01$cov.blocks,
  mValues2 = mS_LDSC.1kg,
  mStandard_errors2 = mS.SE_LDSC.1kg,
  mN2 = matrix(200,nrow(p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.maf0_01$S),ncol(p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.maf0_01$S)),
