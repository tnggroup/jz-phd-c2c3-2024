...
p$folderpath.data.sumstats.imputed<-normalizePath(file.path(p$folderpath.data,"gwas_sumstats","imputed_1kg_eur_supermunge.500Kwin"))
...
p$folderpath.data.sumstats.imputed.500<-normalizePath(file.path(p$folderpath.data,"gwas_sumstats","imputed_1kg_eur_supermunge.500Kwin"))
...
p$filepath.SNPReference.1kg<-normalizePath(file.path(p$folderpath.data.variantLists,"hc1kgp3.b38.eur.l2.jz2022.gz")) #Based on the high coverage 1kgp3 panel in b38
...
p$folderpath.data.mvLDSC.ld.1kg <- file.path(p$folderpath.data,"ld_scores","hc1kgp3.b38.eur.l2.jz2022")
...
p$sumstats$imputedpath.10<-file.path(p$folderpath.data.sumstats.imputed.10,paste0(p$sumstats$code,p$filename.suffix.data.sumstats.munged))

p$sumstats$imputedpath.500<-file.path(p$folderpath.data.sumstats.imputed.500,paste0(p$sumstats$code,p$filename.suffix.data.sumstats.munged))
...
if(p$host=="local"){
  p$sumstats["BODY11",]$cleanedpath<-"/Users/jakz/Documents/local_db/JZ_GED_PHD_ADMIN_GENERAL/data/gwas_sumstats/raw/bmi.giant-ukbb.meta-analysis.combined.23May2018.txt.gz"
} else {
  p$sumstats["BODY11",]$cleanedpath<-"/users/k19049801/project/JZ_GED_PHD_C1/data/gwas_sumstats/raw/bmi.giant-ukbb.meta-analysis.combined.23May2018.txt.gz"
}
...
p$sumstats.sel.gwis.code<-c("ANXI03","BODYTM","BODY11","BIPO02","DEPR05","DEPR5B","DEPR09","EDUC03","GWISI","INSO02","NEUR02","SCHI04")
...
#TODO Add mirroring of the p-matrix to ldsc
