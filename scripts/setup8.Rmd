...
offDiagCovstructS<-p$mvLD$covstruct.GCTA$S
...
createTableEntriesFull<-function(code,cCovstruct,simulatedTraitsTable){
  ...
  sqrt(mean((cCovstruct$S-p$mvLD$covstruct.GCTA$S)^2,na.rm=T)),
...
createTableEntriesPairwise<-function(code,cCovstruct,simulatedTraitsTable,t1,t2){
  ...
  sqrt(mean((cCovstruct$S[c(t1,t2),c(t1,t2)]-p$mvLD$covstruct.GCTA$S[c(t1,t2),c(t1,t2)])^2,na.rm=T)),
...
offDiagCovstructS.SE<-p$mvLD$covstruct.GCTA$S.SE
...
createTableEntriesFull<-function(code,cCovstruct,simulatedTraitsTable){
  #cols <-c("Avg. SIM1 LDSR h2 S.E.","Avg. SIM1 REML h2 S.E.","Avg. SIM2 LDSR h2 S.E.","Avg. SIM2 REML h2 S.E.","Avg. SIM LDSR h2 S.E.","Avg. SIM REML h2 S.E.","Avg. SIM1 & SIM2 LDSR covG S.E.","Avg. SIM1 & SIM2 REML covG S.E.","RMSE(S S.E.)","RMSE(diag S S.E.)","RMSE(off diag S S.E.)")
   cols <-c("Avg. SIM1 h2 S.E.","Avg. SIM2 h2 S.E.","Avg. SIM h2 S.E.","Avg. SIM1 & SIM2 covG S.E.","RMSE(S S.E.)","RMSE(diag S S.E.)","RMSE(off diag S S.E.)")
  simulatedTraitsTable[code,cols]<-c(
  ...
  sqrt(mean((cCovstruct$S.SE-p$mvLD$covstruct.GCTA$S.SE)^2,na.rm=T)),
...
# Create simulation results table for main manuscript
