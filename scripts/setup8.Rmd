...
ggplot(data = p$cv_coverage, aes(x=m, y=cv, shape=l, color=g)) +
  ...
  stat_cor(method="pearson", label.x.npc = 0.5,label.y.npc = 0.4, aes(group=g))
  #stat_cor(method="pearson", label.x.npc = "middle",label.y.npc = "bottom")
ggsave(filename=file.path(p$folderpath.plots,"ldsc_m_cv.all.png"), plot = last_plot(), width = 200, height = 200, units = "mm")
...
ggplot(data = p$cv_coverage, aes(x=m, y=se, shape=l, color=g)) +
  ...
  stat_cor(method="pearson", label.x.npc = 0.3,label.y.npc = 0.3, aes(group=g, color=g))
  #stat_cor(method="pearson", label.x.npc = "middle",label.y.npc = "bottom")
ggsave(filename=file.path(p$folderpath.plots,"ldsc_m_se.all.png"), plot = last_plot(), width = 200, height = 200, units = "mm")
...
par(xpd=TRUE) #keep labels inside margins
pal<-colorRampPalette(c("#FF6666","#EEEEEE","#6666FF"))
corrplot(corr = corrForPlot, method = "circle", insig='blank', order = "original", p.mat = pForPlot, sig.level = c(0.05), pch.cex = 1.5, tl.cex = 0.8, full_col=FALSE, na.label = "square", na.label.col = "grey30", title = "C: LDSC++ genetic correlations, HC1kGP3 reference:\nLD-IMP augmented GWAS + GWIS of male BMI (LD-IMP augmented height & weight)", tl.pos = 'd', mar=c(0,0,4,0), type = "upper", cl.pos = "r", col = pal(200))$corrPos -> p1 #type = "lower", diag=F, addCoef.col = 'black'
#text(p1$x, p1$y, round(p1$corr, 2))
p1$corr <- ifelse(0==-p1$y + ncol(corrForPlot)-p1$x + 1, NA_real_, p1$corr)
text(p1$x, p1$y, round(p1$corr, 2))
dev.off()
...
par(xpd=TRUE) #keep labels inside margins
pal<-colorRampPalette(c("#FF6666","#EEEEEE","#6666FF"))
corrplot(corr = corrForPlot, method = "circle", insig='blank', order = "original", p.mat = pForPlot, sig.level = c(0.05), pch.cex = 1.5, tl.cex = 0.8, full_col=FALSE, na.label = "square", na.label.col = "grey30", title = "D: LDSC++ genetic unsigned correlations, HC1kGP3 reference:\nGWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight)", tl.pos = 'd', mar=c(0,0,4,0), type = "upper", cl.pos = "r", col = pal(200))$corrPos -> p1 #type = "lower", diag=F, addCoef.col = 'black'
#text(p1$x, p1$y, round(p1$corr, 2))
p1$corr <- ifelse(0==-p1$y + ncol(corrForPlot)-p1$x + 1, NA_real_, p1$corr)
text(p1$x, p1$y, round(p1$corr, 2))
dev.off()
...
par(xpd=TRUE) #keep labels inside margins
pal<-colorRampPalette(c("#FF6666","#EEEEEE","#6666FF"))
corrplot(corr = corrForPlot, method = "circle", insig='blank', order = "original", p.mat = pForPlot, sig.level = c(0.05), pch.cex = 1.5, tl.cex = 0.8, full_col=FALSE, na.label = "square", na.label.col = "grey30", title = "E: LDSC++ 'residual' genetic correlations, HC1kGP3 reference:\nGWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight)", tl.pos = 'd', mar=c(0,0,4,0), type = "upper", cl.pos = "r", col = pal(200))$corrPos -> p1 #type = "lower", diag=F, addCoef.col = 'black'
#text(p1$x, p1$y, round(p1$corr, 2))
p1$corr <- ifelse(0==-p1$y + ncol(corrForPlot)-p1$x + 1, NA_real_, p1$corr)
text(p1$x, p1$y, round(p1$corr, 2))
dev.off()
...
p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.vbcs.nocm, code = "vbcs", titleTemplate = "LDSC++, 1kGP3 reference,
...
p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.vbcs, code = "vbcs.cm", titleTemplate = "LDSC++, 1kGP3 reference,
GWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight),", titleAddition = "\nVariable Block-Count Sampling (cM blocks)",mvldscComparison = p$mvLD$covstruct.mvLDSC.1kg.original, titleAdditionComparison = "\ncomparing with original LDSC (Genomic SEM) settings\n and Block-Jackknife Resampling")

p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.vbcs.nocm, code = "vbcs.nocmcm", titleTemplate = "LDSC++, 1kGP3 reference,
...
p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.vbcs.nocm.winfo, code = "vbcs.winfo",titleTemplate = "LDSC++, 1kGP3 reference,
...
p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.vbcs.nocm.winfo, code = "1kg",titleTemplate = "LDSC++, 1kGP3 reference,
GWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight)",mvldscComparison = p$mvLD$covstruct.mvLDSC.hm3,titleAdditionComparison = "\ncomparing with HM3")

p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.hm3res.vbcs.nocm.winfo, code = "1kg.hm3res",titleTemplate = "LDSC++, 1kGP3 reference, restricted to HM3,
GWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight)")

p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.hc1kg.hm3res, code = "panel.hc1kg.hm3res_1kg",titleTemplate = "LDSC++, HC1kGP3 reference, restricted to HM3,
GWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight)",mvldscComparison = p$mvLD$covstruct.mvLDSC.1kg.hm3res.vbcs.nocm.winfo,titleAdditionComparison = "\ncomparing with 1kGP3 restricted to HM3 variants")
...
p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.hc1kg, code = "panel.hc1kg_1kg",titleAddition = "HC1kGP3",mvldscComparison = p$mvLD$covstruct.mvLDSC.1kg.vbcs.nocm.winfo, titleAdditionComparison = "\ncomparing with 1kG")
...
p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.05cm, code = "ldimp",titleAddition = "0.5cM imputation window",mvldscComparison = p$mvLD$covstruct.mvLDSC.1kg.vbcs.nocm.winfo, testOnlyTraitNameCodes = imptraits,titleTemplate = "HC1kGP3 reference,\nLD-IMP augmented GWAS + GWIS of male BMI (LD-IMP augmented height & weight),\n", titleAdditionComparison = "\ncomparing with LDSC++ of non-imputed GWAS")

p$plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.500.small, code = "ldimp.small",titleAddition = "(selected chromosomes)",mvldscComparison = p$mvLD$covstruct.mvLDSC.1kg.ssimp.small,titleTemplate = "HC1kGP3 reference,\nLD-IMP augmented GWAS (500kb imputation window) + GWIS of male BMI (LD-IMP augmented height & weight),\n", titleAdditionComparison = "\ncomparing with LDSC++ of SSimp imputed GWAS")
