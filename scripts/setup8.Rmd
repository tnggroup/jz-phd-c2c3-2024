...
if(p$clOptions$task=="mvLD" || (!file.exists(p$filepath.mvLD) & p$clOptions$task=="0"))
{
  ...
  #   traits = p$sumstats.sel.ssimp$mungedpath.ldsc.1kg.orig.maf0_05.info0,
  #   sample.prev =  p$sumstats.sel.ssimp$samplePrevalence.balanced,
  #   population.prev = p$sumstats.sel.ssimp$populationPrevalence,
  #   trait.names = p$sumstats.sel.ssimp$code,
  #   ld = p$folderpath.data.mvLDSC.ld.1kg,
  ...
  #   traits = p$sumstats.sel.ssimp$mungedpath.ldsc.hm3, #we need all columns - INFO
  #   sample.prev =  p$sumstats.sel.ssimp$samplePrevalence.balanced,
  #   population.prev = p$sumstats.sel.ssimp$populationPrevalence,
  #   trait.names = p$sumstats.sel.ssimp$code,
  #   ld = p$folderpath.data.mvLDSC.ld.hm3,
  ...
  cat("\n\n*** LDSC: covstruct.mvLDSC.hm3.vbcs.varblock.winfo.altcw.nohighld ***\n")
  p$mvLD$covstruct.mvLDSC.hm3.vbcs.varblock.winfo.altcw.nohighld<-ldscpp(
    traits = p$sumstats.sel.ssimp$mungedpath.ldsc.hm3, #we need all columns - INFO
    sample.prev =  p$sumstats.sel.ssimp$samplePrevalence.balanced,
    population.prev = p$sumstats.sel.ssimp$populationPrevalence,
    trait.names = p$sumstats.sel.ssimp$code,
  ...
  saveRDS(object = p$mvLD,file = p$filepath.mvLD)
  cat("\n\n***END LDSC: covstruct.mvLDSC.hm3.vbcs.varblock.winfo.altcw.nohighld ***\n")
  ...
  cat("\n\n*** LDSC: covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw.nohighld ***\n")
  p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw.nohighld<-ldscpp(
    traits = p$sumstats.sel.ssimp$mungedpath.supermunge.1kg.orig.unfiltered, #we need all columns - INFO
    sample.prev =  p$sumstats.sel.ssimp$samplePrevalence.balanced,
    population.prev = p$sumstats.sel.ssimp$populationPrevalence,
    trait.names = p$sumstats.sel.ssimp$code,
...
p$sumstats$h2.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05<-NA_real_
p$sumstats$h2.se.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05<-NA_real_
p$sumstats[p$sumstats.sel.ssimp.code,c("h2.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05")]<-diag(p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.hm3res$S)[p$sumstats.sel.ssimp.code]
p$sumstats[p$sumstats.sel.ssimp.code,c("h2.se.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05")]<-diag(p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.hm3res$S.SE)[p$sumstats.sel.ssimp.code]
...
# Overview of LD score regression CV's NEW
```{r overview ldsc cv NEW, fig.width=9, fig.height=6, out.width="1600px", out.height="1000px", eval=FALSE, purl=FALSE}

p$getCVDataframe<-function(cCovstruct,labelString,groupString,cv.S_StandLimit = 0.05){
  S<-abs(cCovstruct$S)
  S[S<cv.S_StandLimit]<-cv.S_StandLimit
  S.CV <- cCovstruct$S.SE/S
...
#individual methods
p$cv_coverage.GSEMemulation.1kg.jn.varblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.jn.varblock.winfo.altcw, labelString = "1kg.jn.varblock", groupString = "1kg.jn.varblock")

p$cv_coverage.GSEMemulation.1kg.jn.rblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.jn.rblock.winfo.altcw, labelString = "1kg.jn.rblock", groupString = "1kg.jn.rblock")

p$cv_coverage.GSEMemulation.1kg.vbcs.varblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw, labelString = "1kg.vbcs.varblock", groupString = "1kg.vbcs.varblock")

p$cv_coverage.GSEMemulation.1kg.vbcs.rblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.rblock.winfo.altcw, labelString = "1kg.vbcs.rblock", groupString = "1kg.vbcs.rblock")

p$cv_coverage <- rbind(
  #p$cv_coverage.GSEMemulation.1kg.jn.fixed,
  p$cv_coverage.GSEMemulation.1kg.jn.varblock,
  p$cv_coverage.GSEMemulation.1kg.jn.rblock,
  p$cv_coverage.GSEMemulation.1kg.vbcs.varblock,
  p$cv_coverage.GSEMemulation.1kg.vbcs.rblock
  )
...
ggplot(data = p$cv_coverage, aes(x=m, y=cv, shape=l, color=g)) +
  ...
  ggtitle(label = "LDSC number of variants against covG coefficient of variance (CV)") + 
...
ggplot(data = p$cv_coverage[p$cv_coverage$isDiag==T,], aes(x=m, y=cv, shape=l, color=g)) +
  ...
  ggtitle(label = "LDSC number of variants against h2 coefficient of variance (CV)") + 
...
#block methods
p$cv_coverage.GSEMemulation.1kg.jn.varblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.jn.varblock.winfo.altcw, labelString = "1kg.jn.varblock", groupString = "varblock")

p$cv_coverage.GSEMemulation.1kg.jn.rblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.jn.rblock.winfo.altcw, labelString = "1kg.jn.rblock", groupString = "rblock")

p$cv_coverage.GSEMemulation.1kg.vbcs.varblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw, labelString = "1kg.vbcs.varblock", groupString = "varblock")

p$cv_coverage.GSEMemulation.1kg.vbcs.rblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.rblock.winfo.altcw, labelString = "1kg.vbcs.rblock", groupString = "rblock")
...
p$cv_coverage.GSEMemulation.1kg.jn.varblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.jn.varblock.winfo.altcw, labelString = "1kg.jn.varblock", groupString = "jn")

p$cv_coverage.GSEMemulation.1kg.jn.rblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.jn.rblock.winfo.altcw, labelString = "1kg.jn.rblock", groupString = "jn")

p$cv_coverage.GSEMemulation.1kg.vbcs.varblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw, labelString = "1kg.vbcs.varblock", groupString = "vbcs")

p$cv_coverage.GSEMemulation.1kg.vbcs.rblock <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.rblock.winfo.altcw, labelString = "1kg.vbcs.rblock", groupString = "vbcs")
...
p$cv_coverage.GSEMemulation.hm3.vbcs.varblock.winfo.altcw <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.hm3.vbcs.varblock.winfo.altcw, labelString = "hm3.vbcs.varblock.winfo.altcw", groupString = "hm3")

p$cv_coverage.GSEMemulation.1kg.vbcs.varblock.winfo.altcw <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw, labelString = "1kg.vbcs.varblock.winfo.altcw", groupString = "1kg")

p$cv_coverage.GSEMemulation.hc1kg.vbcs.varblock.winfo.altcw <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw, labelString = "hc1kg.vbcs.varblock.winfo.altcw", groupString = "hc1kg")

p$cv_coverage <- rbind(
p$cv_coverage.GSEMemulation.hm3.vbcs.varblock.winfo.altcw,
p$cv_coverage.GSEMemulation.1kg.vbcs.varblock.winfo.altcw,
p$cv_coverage.GSEMemulation.hc1kg.vbcs.varblock.winfo.altcw
  )
...
# panels, no high ld regions, in LDSC++

p$cv_coverage.GSEMemulation.hm3.vbcs.varblock.winfo.altcw.nohighld <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.hm3.vbcs.varblock.winfo.altcw.nohighld, labelString = "hm3.vbcs.varblock.winfo.altcw.nohighld", groupString = "hm3")

p$cv_coverage.GSEMemulation.1kg.vbcs.varblock.winfo.altcw.nohighld <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw.nohighld, labelString = "1kg.vbcs.varblock.winfo.altcw.nohighld", groupString = "1kg")

p$cv_coverage.GSEMemulation.hc1kg.vbcs.varblock.winfo.altcw.nohighld <- p$getCVDataframe(cCovstruct = p$mvLD$covstruct.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw.nohighld, labelString = "hc1kg.vbcs.varblock.winfo.altcw.nohighld", groupString = "hc1kg")

p$cv_coverage <- rbind(
p$cv_coverage.GSEMemulation.hm3.vbcs.varblock.winfo.altcw.nohighld,
p$cv_coverage.GSEMemulation.1kg.vbcs.varblock.winfo.altcw.nohighld,
p$cv_coverage.GSEMemulation.hc1kg.vbcs.varblock.winfo.altcw.nohighld
  )
...
ggplot(data = p$cv_coverage, aes(x=m, y=cv, shape=l, color=g)) +
  ...
  stat_cor(method="pearson", label.x.npc = 0.3,label.y.npc = 0.9, aes(group=g))
  #stat_cor(method="pearson", label.x.npc = "middle",label.y.npc = "bottom")
ggsave(filename=file.path(p$folderpath.plots,"ldsc_m_cv.panel.nohighld.covG.png"), plot = last_plot(), width = 200, height = 200, units = "mm")
...
ggplot(data = p$cv_coverage, aes(x=m, y=se, shape=l, color=g)) +
  ...
  stat_cor(method="pearson", label.x.npc = 0.5,label.y.npc = 0.4, aes(group=g, color=g))
  #stat_cor(method="pearson", label.x.npc = "middle",label.y.npc = "bottom")
ggsave(filename=file.path(p$folderpath.plots,"ldsc_m_se.panel.nohighld.covG.png"), plot = last_plot(), width = 200, height = 200, units = "mm")
...
ggplot(data = p$cv_coverage[p$cv_coverage$isDiag==T,], aes(x=m, y=cv, shape=l, color=g)) +
  ...
  stat_cor(method="pearson", label.x.npc = 0.4,label.y.npc = 0.8, aes(group=g))
  #stat_cor(method="pearson", label.x.npc = "middle",label.y.npc = "bottom")
ggsave(filename=file.path(p$folderpath.plots,"ldsc_m_cv.panel.nohighld.h2.png"), plot = last_plot(), width = 200, height = 200, units = "mm")
...
ggplot(data = p$cv_coverage[p$cv_coverage$isDiag==T,], aes(x=m, y=se, shape=l, color=g)) +
  ...
  stat_cor(method="pearson", label.x.npc = 0.5,label.y.npc = 0.4, aes(group=g, color=g))
  #stat_cor(method="pearson", label.x.npc = "middle",label.y.npc = "bottom")
ggsave(filename=file.path(p$folderpath.plots,"ldsc_m_se.panel.nohighld.h2.png"), plot = last_plot(), width = 200, height = 200, units = "mm")
...
par(xpd=TRUE) #keep labels inside margins
pal<-colorRampPalette(c("#FF6666","#EEEEEE","#6666FF"))
corrplot(corr = corrForPlot, method = "circle", insig='blank', order = "original", p.mat = pForPlot, sig.level = c(0.05), pch.cex = 1.5, tl.cex = 0.8, full_col=FALSE, na.label = "square", na.label.col = "grey30", title = "A: LDSC++ genetic correlations, HC1kGP3 reference:\nGWAS (non-imputed) + GWIS of male BMI (LD-IMP augmented height & weight)", tl.pos = 'd', mar=c(0,0,4,0), type = "upper", cl.pos = "r", col = pal(200))$corrPos -> p1 #type = "lower", diag=F, addCoef.col = 'black'
...
plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.maf0_05, folderpath.plots = p$folderpath.plots, code = "original.1kg", titleTemplate = "original LDSC (Genomic SEM emulated), 1kGP3 reference", titleAddition = "\nBlock Jackknife Resampling")
...
plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw, folderpath.plots = p$folderpath.plots, code = "1kg.vbcs", titleTemplate = "LDSC++, 1kGP3 reference", titleAddition = "\nVariable Block-Count Sampling",mvldscComparison = p$mvLD$covstruct.mvLDSC.GSEMemulation.1kg.maf0_05,titleAdditionComparison = "\ncomparing with original LDSC (Genomic SEM emulated)")

plotAndTestBatteryForMVLDSC(mvldsc = p$mvLD$covstruct.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw, folderpath.plots = p$folderpath.plots, code = "hc1kg.vbcs", titleTemplate = "LDSC++, HC1kGP3 reference", titleAddition = "\nVariable Block-Count Sampling", mvldscComparison = p$mvLD$covstruct.mvLDSC.1kg.vbcs.varblock.winfo.altcw,titleAdditionComparison = "\ncomparing with 1kGP3 reference") 
...
p$sumstats.varcodes.h2<-c(
                                        ...
                                        "h2.LDSC.1kg.maf0_05",
                                        "h2.LDSC.1kg.maf0_1",
                                        "h2.LDSC.hc1kg.maf0_05",
                                        "h2.LDSC.hc1kg.maf0_1",
                                        "h2.GSEMmvLDSC.hm3",
                                        "h2.mvLDSC.GSEMemulation.hm3",
                                        "h2.mvLDSC.GSEMemulation.1kg.maf0_05",
                                        "h2.mvLDSC.GSEMemulation.1kg.maf0_1",
                                        "h2.mvLDSC.GSEMemulation.hc1kg.maf0_05",
                                        "h2.mvLDSC.GSEMemulation.hc1kg.maf0_1",
                                        "h2.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05",
                                        ...
                                        "h2.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw",
                                        "h2.mvLDSC.hc1kg.vbcs.rblock.winfo.altcw",
                                        "h2.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw.ldimp",
                                        "h2.mvLDSC.hc1kg.vbcs.rblock.winfo.altcw.ldimp"
                                        )
p$sumstats.varcodes.se<-c(
                                        ...
                                        "h2.se.LDSC.hc1kg.maf0_05",
                                        "h2.se.LDSC.hc1kg.maf0_1",
                                        ...
                                        "h2.se.mvLDSC.GSEMemulation.hc1kg.maf0_05",
                                        "h2.se.mvLDSC.GSEMemulation.hc1kg.maf0_1",
                                        "h2.se.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05",
                                        ...
                                        "h2.se.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw",
                                        "h2.se.mvLDSC.hc1kg.vbcs.rblock.winfo.altcw",
                                        "h2.se.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw.ldimp",
                                        "h2.se.mvLDSC.hc1kg.vbcs.rblock.winfo.altcw.ldimp"
                                        )
p$sumstats.varcodes.cv<-c(
                                        ...
                                        "h2.cv.LDSC.hc1kg.maf0_05",
                                        "h2.cv.LDSC.hc1kg.maf0_1",
                                        ...
                                        "h2.cv.mvLDSC.GSEMemulation.hc1kg.maf0_05",
                                        "h2.cv.mvLDSC.GSEMemulation.hc1kg.maf0_1",
                                        "h2.cv.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05",
                                        ...
                                        "h2.cv.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw",
                                        "h2.cv.mvLDSC.hc1kg.vbcs.rblock.winfo.altcw",
                                        "h2.cv.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw.ldimp",
                                        "h2.cv.mvLDSC.hc1kg.vbcs.rblock.winfo.altcw.ldimp"
                                        )
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
                                                    ...
                                                    "h2.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05.combined",
  ...
  tab_header(
    ...
    name.nice.and_code = "Trait",
    h2.LDSC.hm3.plainN.combined  = "LDSC, HM3, plain N",
    h2.LDSC.hm3.combined = "LDSC, HM3",
    h2.GSEMmvLDSC.hm3.combined = "Genomic SEM LDSC, HM3",
    h2.mvLDSC.GSEMemulation.hm3.combined = "LDSC++ emulating Genomic SEM LDSC, HM3",
    h2.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05.combined = "LDSC++ emulating Genomic SEM LDSC, 1kGP3 (MAF>0.05) restricted to HM3",
    h2.LDSC.1kg.maf0_05.combined = "LDSC, 1kGP3 (MAF>0.05)",
    h2.mvLDSC.GSEMemulation.1kg.maf0_05.combined = "LDSC++ emulating Genomic SEM LDSC, 1kGP3 (MAF>0.05)"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
  ...
  tab_header(
    ...
    name.nice.and_code = "Trait",
    h2.LDSC.hm3.plainN  = "LDSC, HM3, plain N",
    h2.LDSC.hm3 = "LDSC, HM3",
    h2.GSEMmvLDSC.hm3 = "Genomic SEM LDSC, HM3",
    h2.mvLDSC.GSEMemulation.hm3 = "LDSC++ emulating Genomic SEM LDSC, HM3",
    h2.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05 = "LDSC++ emulating Genomic SEM LDSC, 1kGP3 (MAF>0.05) restricted to HM3",
    h2.LDSC.1kg.maf0_05 = "LDSC, 1kGP3 (MAF>0.05)",
    h2.mvLDSC.GSEMemulation.1kg.maf0_05 = "LDSC++ emulating Genomic SEM LDSC, 1kGP3 (MAF>0.05)"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
  ...
  tab_header(
    ...
    name.nice.and_code = "Trait",
    h2.cv.LDSC.hm3.plainN  = "LDSC, HM3, plain N",
    h2.cv.LDSC.hm3 = "LDSC, HM3",
    h2.cv.GSEMmvLDSC.hm3 = "Genomic SEM LDSC, HM3",
    h2.cv.mvLDSC.GSEMemulation.hm3 = "LDSC++ emulating Genomic SEM LDSC, HM3",
    h2.cv.mvLDSC.GSEMemulation.1kg.hm3res.maf0_05 = "LDSC++ emulating Genomic SEM LDSC, 1kGP3 (MAF>0.05) restricted to HM3",
    h2.cv.LDSC.1kg.maf0_05 = "LDSC, 1kGP3 (MAF>0.05)",
    h2.cv.mvLDSC.GSEMemulation.1kg.maf0_05 = "LDSC++ emulating Genomic SEM LDSC, 1kGP3 (MAF>0.05)"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
#selected sumstats, 1kg MAF thresholds heritabilities
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
                                                    "h2.LDSC.1kg.maf0_1",
                                                "h2.mvLDSC.GSEMemulation.1kg.maf0_1",
                                                    "h2.LDSC.hc1kg.maf0_1",
  ...
  #fmt_number(columns = vars(chisquare_mean), decimals = 2) %>%
  tab_header(
    title = "LDSC++ trait heritabilities (coefficient of variation): panel comparison, 1kGP3 LD scores MAF > 0.1"
  ) %>% cols_label(
     name.nice.and_code = "Trait",
    h2.LDSC.1kg.maf0_1 = "LDSC 1kG",
    h2.mvLDSC.GSEMemulation.1kg.maf0_1 = "LDSC++ emulating Genomic SEM LDSC 1kG",
    h2.LDSC.hc1kg.maf0_1 = "LDSC HC1kG",
    h2.mvLDSC.GSEMemulation.hc1kg.maf0_1 = "LDSC++ emulating Genomic SEM LDSC HC1kG"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
gtsave(data = p$plots.sumstats.sel.table, filename = paste0(p$folderpath.plots,"/sumstats.sel.table.heritabilities.panel.h2.maf0_1.rtf"))
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
  ...
  #fmt_number(columns = vars(chisquare_mean), decimals = 2) %>%
  tab_header(
    title = "LDSC++ trait heritabilities (coefficient of variation): panel comparison, 1kG panels MAF > 0.1"
  ) %>% cols_label(
     name.nice.and_code = "Trait",
    h2.cv.LDSC.1kg.maf0_1 = "LDSC 1kG",
    h2.cv.mvLDSC.GSEMemulation.1kg.maf0_1 = "LDSC++ emulating Genomic SEM LDSC 1kG",
    h2.cv.LDSC.hc1kg.maf0_1 = "LDSC HC1kG",
    h2.cv.mvLDSC.GSEMemulation.hc1kg.maf0_1 = "LDSC++ emulating Genomic SEM LDSC HC1kG"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
gtsave(data = p$plots.sumstats.sel.table, filename = paste0(p$folderpath.plots,"/sumstats.sel.table.heritabilities.panel.h2cv.maf0_1.rtf"))


#selected sumstats, 1kg MAF thresholds
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
                                                    "h2.LDSC.hm3.combined",
                                                    "h2.LDSC.1kg.maf0_05.combined",
                                                "h2.mvLDSC.GSEMemulation.1kg.maf0_05.combined",
                                                    "h2.LDSC.hc1kg.maf0_05.combined",
                                                "h2.mvLDSC.GSEMemulation.hc1kg.maf0_05.combined"
                                                )] %>% 
  gt() %>% 
  #fmt_number(columns = vars(chisquare_mean), decimals = 2) %>%
  tab_header(
    title = "LDSC++ trait heritabilities (coefficient of variation): panel comparison, 1kG panels MAF > 0.05"
  ) %>% cols_label(
     name.nice.and_code = "Trait",
    h2.LDSC.hm3.combined = "LDSC HM3",
    h2.LDSC.1kg.maf0_05.combined = "LDSC 1kG",
    h2.mvLDSC.GSEMemulation.1kg.maf0_05.combined = "LDSC++ emulating Genomic SEM LDSC 1kG",
    h2.LDSC.hc1kg.maf0_05.combined = "LDSC HC1kG",
    h2.mvLDSC.GSEMemulation.hc1kg.maf0_05.combined = "LDSC++ emulating Genomic SEM LDSC HC1kG"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
gtsave(data = p$plots.sumstats.sel.table, filename = paste0(p$folderpath.plots,"/sumstats.sel.table.heritabilities.panel.maf0_05.rtf"))
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
  ...
  #fmt_number(columns = vars(chisquare_mean), decimals = 2) %>%
  tab_header(
    title = "LDSC++ trait heritabilities (coefficient of variation): LDSC++ methods, 1kGP3 panel MAF > 0.05"
  ) %>% cols_label(
     name.nice.and_code = "Trait",
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
 ...
 "h2.mvLDSC.hm3.vbcs.varblock.winfo.altcw",
  ...
  #fmt_number(columns = vars(chisquare_mean), decimals = 2) %>%
  tab_header(
    title = "LDSC++ trait heritabilities (coefficient of variation): LDSC++ panels, MAF > 0.05"
  ) %>%
  tab_style(
    style = cell_text(size = px(14)),
    locations = cells_column_labels(everything())       
...
p$plots.sumstats.sel.table<-p$sumstats.sel.table[,c("name.nice.and_code",
                                     ...
                                     "h2.mvLDSC.1kg.vbcs.varblock.winfo.altcw.combined",
                                                    "h2.LDSC.hc1kg.maf0_05.combined",
                                    "h2.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw.combined",                                 "h2.mvLDSC.hc1kg.vbcs.varblock.winfo.altcw.ldimp.combined"
                                                )] %>% 
  gt() %>% 
  #fmt_number(columns = vars(chisquare_mean), decimals = 2) %>%
  tab_header(
...
gtsave(data = p$plots.sumstats.sel.table, filename = paste0(p$folderpath.plots,"/sumstats.sel.table.heritabilities.ldscpp.panels.rtf"))
